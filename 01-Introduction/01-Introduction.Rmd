...
<!-- pagedown::chrome_print("C:/Users/Jason/Box/Teaching/Jason Cook/QAMO_UG_Intro_Metrics/Lectures/01-Introduction/01-Introduction.html") -->
...
knitr::include_graphics("https://sites.google.com/site/jasonblainecook/_/rsrc/1579376979604/home/Jason%20Cook%20ABC_9457_edit.png?height=320&width=258")
```
...
.pull-left[
- **Blake Peterman**
- **Email:** .url[u0965622@utah.edu]

- **Office Hours:** T/F 4pm-5pm
    - **Zoom ID:** 988 6826 2146
    - **Password:** 4651
]
.pull-right[
```{r out.width = '90%', echo = F}
knitr::include_graphics("https://ca.slack-edge.com/T015CRGBZL3-U019Y2PRDDE-ca2179b3f511-512")
```
]
...
<iframe width="360" height="515" src="Snoop_Dogg.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
knitr::include_graphics("https://media.giphy.com/media/iH1rdIKYvNhOu5Z8RY/giphy.gif")
```
---
...
- 6 Problem Sets .hi[(25 pts each - 25%)]
  ...
  + Optional groups of up to 4 .hi[(graded as a group)]
...
- Midterm - ProctorU .hi[(100 pts - 20%)]
- Comprehensive Final - ProctorU .hi[(150 pts - 30%)]
--

- Scores curved within the class
  - This is a challenging course and so curve will most likely be used to move student scores .green[**upward**] to achieve a reasonable class distribution

---

## Contesting Grades

- You have .hi[two weeks] from when returned to contest grades on any assignment
- First, consult with TA to try to come to resolution
- If that fails, then I will regrade
- You must accept my scoring as final, even if it is lower than the original grade
  - In the past, I've been a tougher grader than my TA so factor that in
...
- I will utilize Slack for this course rather than email .green[**(response guaranteed)**]

- Please do not email me .red[**(you may not get a response)**]
...
- Be sure to add .pink[profile pictures] as well. It helps to feel connected in these remote semesters.
...
---
## In Class
- We will periodically use Slack in class for impromptu polling and group activities, so have it ready

  - These will appear in .mono[\#in-class] channel

- You can also post questions about lecture material in .mono[\#lecture]

  - These will be answered by myself, the TA, and your fellow peers .pink[(not necessarily during class time)]

  - For questions you want an immediate answer to, use Zoom features (described shortly)

--

Let's practice...

Open up Slack, see you there
...
- TA and I will monitor Slack to answer questions as well

- To ask a specific question to me or Blake, be sure to tag us in the post using @
...
## Bonus
To help facilitate activity on Slack. At the end of the semester, I will subjectively award up to .hi[25 points] (equivalent to one full problem-set) to each student based on their activity on Slack

Activity includes both asking and answering questions, though I'll put more weight on answering

```{r out.width = '50%', echo = F}
knitr::include_graphics("https://media.giphy.com/media/26ybxqF6r4w1pjjws/giphy.gif")
```
...
## Direct Messages:
- Send direct messages jointly to myself .hi[and the TA] for any personal questions or concerns
...
## Group Questions
- will regularly split into small groups to discuss content
- Let's practice, just introduce yourselves to your other group members for a few minutes and I'll bounce around
]

.pull-right[
```{r out.width = '100%', echo = F}
knitr::include_graphics("https://media.giphy.com/media/JOGDMviQHZvC2QGWeg/giphy.gif")
```
```{r out.width = '100%', echo = F}
knitr::include_graphics("https://media.giphy.com/media/J4nBhoXcAOOXwNC5D7/giphy.gif")
```
]
...
- I'll use poll everywhere for most in-class polling

- These polls are to gauge understanding and will not be for points

- No need to enroll in Poll Everywhere, just click links in Slack channel
  - But enrolling does make it a bit faster for you
...
<iframe src="https://embed.polleverywhere.com/multiple_choice_polls/EILGeooi0BlfDZPHCrTdp?controls=none&short_poll=true" width="800" height="600" frameBorder="0"></iframe>
...
- __Logical Conditions (AND):__ `gen big_ne=region==1 & smsa==1`
